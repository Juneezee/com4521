 ...
 *  2) Either setNBodyPositions2f(...) or setNBodyPositions(...) depending on how your nbody data is stored. This/These pointer(s) will be used to update the rendered positions of the bodys
